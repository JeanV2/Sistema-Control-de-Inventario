...
namespace CapaPresentacion
{
    public partial class FrmSolicitudEntrega : Form
    {
        ...
        public void GenerarPDF()
        {
            ...
            //*************************
            string PaginaHTML_Texto = Properties.Resources.PDFPlantillaEntrega.ToString();

            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@TipoSolicitud", CbTipoSilicitud.SelectedItem.ToString()); 
        
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@N_Referencia", TxtReferencia.Text);
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@fecha", DateTime.Now.ToShortDateString());
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@Responsable", TxtCedula.Text);
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@Solicitante", TxtSolicitadoPor.Text);
